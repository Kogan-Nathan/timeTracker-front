...
export default function UserArea(props) {
    ...
    //             <input className="grid-project-item-2" type="text" placeholder={props.project.projectName} onChange={(e)=>{setProjectsName(e.target.value)}}/>
    ...
    //             <span className="grid-project-item-4">Client: <input type="text" placeholder={props.project.projectClient} onChange={(e)=>{setProjectClient(e.target.value)}}/></span>
    //             <span className="grid-project-item-5">PM: <input type="text" placeholder={props.project.projectManager} onChange={(e)=>{setProjectManager(e.target.value)}}/></span>
    //             <span className="grid-project-item-6">Total Workers: {totalWorkersCalc()}</span>
    //             <span className="grid-project-item-7">Status: {convertStatus(props.project.projectStatus)}h</span>
    //             <span className="grid-project-item-8">Start Date: {props.project.ProjectDate}</span>
    //             <button className="button general-butt grid-project-item-9" onClick={checkUpdates}>Update Info</button>
    //         </div> : <div className="border-simple project-grid-small">
                ...
                <div className="c"></div>
                        ...
                        {isOpen? <div className="border-simple grid-projectAddAdminInfo">
                            ...
                            <p className="workers">Total Workers: {totalWorkersCalc()}</p>
                                ...
                                <button className="addButton addAdmin-butt" onClick={checkUpdates}>Update Info</button>        
                            </div>
                            </div> :
